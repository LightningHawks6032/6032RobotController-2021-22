...
public class GripPipeline {
	...
	public void process(Mat source0) {
		...
		double blurRadius = 3.710691524001787;
		blur(blurInput, blurType, blurRadius, blurOutput);

		// Step HSV_Threshold0:
		Mat hsvThresholdInput = blurOutput;
		double[] hsvThresholdHue = {0.0, 100.13652463008114};
		double[] hsvThresholdSaturation = {44.92762057729278, 255.0};
		double[] hsvThresholdValue = {139.11870248454937, 255.0};
